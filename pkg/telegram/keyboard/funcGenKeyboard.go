...
func GenKeyboardInlineForProfileMenu(textTopUp string, textWithdraw string, textVerification string, textLanguaage string, languageUserChange string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
...
func GenKeyboardInlineForProfileMenuAdmin(textTopUp string, textWithdraw string, textVerification string, textLanguaage string, languageUserChange string, hideText string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textTopUp, "NM_TOP_UP"),
			tgbotapi.NewInlineKeyboardButtonData(textWithdraw, "NM_WITH_DRAW"),
...
func GenKeyboardInlineForMammothProfile(teleId int64, verificationText string, textPremium string, textCurrentLuck string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
		...
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(fmt.Sprintf("☘️ Удача (%s)", textCurrentLuck), fmt.Sprintf("NM_WRKPNL_CCL?%d", teleId)),
		),
		tgbotapi.NewInlineKeyboardRow(
...
func GenKeyboardInlineForTradingAccount() tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Bitcoin", "NM_TA_WS?BTCUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("Ethereum", "NM_TA_WS?ETHUSDT"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("BNB", "NM_TA_WS?BNBUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("Cardano", "NM_TA_WS?ADAUSDT"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Solana", "NM_TA_WS?SOLUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("Dogecoin", "NM_TA_WS?DOGEUSDT"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Polkadot", "NM_TA_WS?DOTUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("Polygon", "NM_TA_WS?MATICUSDT"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("TRON", "NM_TA_WS?TRXUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("ETH Classic", "NM_TA_WS?ETCUSDT"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Litecoin", "NM_TA_WS?LTCUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("Monero", "NM_TA_WS?XMRUSDT"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Bitcoin Cash", "NM_TA_WS?BCHUSDT"),
			tgbotapi.NewInlineKeyboardButtonData("XRP", "NM_TA_WS?XRPUSDT"),
		),
	)
}

func GenKeyboardInlineForTradingAcWriteSum(BtnUpdate string, needAsset string, btnBack string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(BtnUpdate, fmt.Sprintf("NM_TA_WS?%s", needAsset)),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(btnBack, "NM_TA"),
		),
	)
}

func GenKeyboardInlineForTradingAcWriteSumBack(textBack string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textBack, "NM_TA"),
		),
	)
}

func GenKeyboardInlineForTradingAccountMovePrice(textUp string, textDown string, textDontChange string, textCancel string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textUp, "NM_TA_WT?up"),
			tgbotapi.NewInlineKeyboardButtonData(textDown, "NM_TA_WT?dn"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textDontChange, "NM_TA_WT?dc"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textCancel, "NM_TA"),
		),
	)
}

func GenKeyboardInlineForTradingAcWaitTime(textTenSec string, textThirtySec string, textSixtySec string, textCancel string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textTenSec, "NM_TA_STRTD?10"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textThirtySec, "NM_TA_STRTD?30"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textSixtySec, "NM_TA_STRTD?60"),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textCancel, "NM_TA"),
		),
...
func GenKeyboardInlineForPlayTraidFinish(textReplace string, needWaitTime int, textNewSum string, needCurrency string, textCancel string) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textReplace, fmt.Sprintf("NM_TA_STRTD?%d", needWaitTime)),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textNewSum, fmt.Sprintf("NM_TA_WS?%s", needCurrency)),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(textCancel, "NM_TA"),
		),
...
func GenKeyboardInlineForChangeMamLuck(teleId int64) tgbotapi.InlineKeyboardMarkup {
	return tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Выигрыш", fmt.Sprintf("NM_WKPNL_U?%d,w", teleId)),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Рандом", fmt.Sprintf("NM_WKPNL_U?%d,r", teleId)),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("Проигрыш", fmt.Sprintf("NM_WKPNL_U?%d,l", teleId)),
		),
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("🔙 Назад в профиль", fmt.Sprintf("NM_WORKPANEL_MAM_US?%d", teleId)),
		),
