...
type UserCheckIsCaptcha struct {
	ValueUser int64 `json:"value_user"`
}

type UserCheckIsCaptchaResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
	Result  bool   `json:"result"`
}
...
type UserUpdateTradingAssetResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
}
...
type UserUpdateTradingInvestPriceResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
}
...
type UserUpdateTradingWaitTimeResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
}
...
type UserGetUserTradingParamsResponse struct {
	Status  int             `json:"status"`
	Message string          `json:"message"`
	Result  []TradingParams `json:"result"`
}
...
type UserUpdateTradingMovePriceResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
}
...
type UserTotalEarn struct {
	TotalEarn float64 `json:"total_earned"`
}

type UserGetTotalEarnResponse struct {
	Status  int             `json:"status"`
	Message string          `json:"message"`
	Result  []UserTotalEarn `json:"result"`
}

type UserChangeTotalEarn struct {
	TeleId    int64   `json:"tele_id"`
	EarnMoney float64 `json:"earn_money"`
}

type UserChangeTotalEarnResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
}

type UserCurrentLuck struct {
...
type UserGetCurrentLuckResponse struct {
	Status  int               `json:"status"`
	Message string            `json:"message"`
	Result  []UserCurrentLuck `json:"result"`
}

type AdminChangeLuckUser struct {
	TeleId   int64  `json:"tele_id"`
	NeedLuck string `json:"need_luck"`
}

type AdminChangeLuckUserResponse struct {
	Status  int    `json:"status"`
	Message string `json:"message"`
}
